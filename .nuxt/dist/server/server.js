...
/******/ 			var chunk = require("./" + ({"1":"components/header","2":"components/history-list","3":"components/weather-form","4":"components/weather-info","5":"pages/history/index","6":"pages/index"}[chunkId]||chunkId) + ".js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  fetchWeather({
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`https://api.openweathermap.org/data/2.5/weather?q=${getters.city}&appid=0d05dbed3cecaa1053cb80974ae0e343&units=metric`).then(response => {
  ...
  fetchHistoryWeather({
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`https://api.openweathermap.org/data/2.5/weather?q=${payload}&appid=0d05dbed3cecaa1053cb80974ae0e343&units=metric`).then(response => {
      commit("setWeather", response.data);
...
__webpack_require__.d(components_namespaceObject, "HistoryList", function() { return HistoryList; });
__webpack_require__.d(components_namespaceObject, "WeatherForm", function() { return WeatherForm; });
__webpack_require__.d(components_namespaceObject, "WeatherInfo", function() { return WeatherInfo; });
...
const Header = () => __webpack_require__.e(/* import() | components/header */ 1).then(__webpack_require__.bind(null, 40)).then(c => wrapFunctional(c.default || c));
const HistoryList = () => __webpack_require__.e(/* import() | components/history-list */ 2).then(__webpack_require__.bind(null, 33)).then(c => wrapFunctional(c.default || c));
const WeatherForm = () => __webpack_require__.e(/* import() | components/weather-form */ 3).then(__webpack_require__.bind(null, 35)).then(c => wrapFunctional(c.default || c));
const WeatherInfo = () => __webpack_require__.e(/* import() | components/weather-info */ 4).then(__webpack_require__.bind(null, 34)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
